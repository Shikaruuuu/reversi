...
class Board:
    ...
    def evaluation(self):
        ...
        self.move_pass()
        #重みをかけて評価値に加算
        eval_val += move_num * 2 # 2は重み

        return eval_val #評価値は返す
...
class AI:
    ...
    def select_move(self, board):
        ...
        print(str(board.move_num) + "手 best_val: " + str(best_eval))
